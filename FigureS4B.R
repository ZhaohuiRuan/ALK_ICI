...
library(Seurat)
library(openxlsx)
load('plot_data_FigureS4B.RData')
plot_dat <- dat[,c('ALK.molecular.subtype','clonality')]
...
pdf('FigureS4B.pdf',height = 4,width = 2.5)
ggplot(data = plot_dat,aes(x = alk_group,y = clonality))+
